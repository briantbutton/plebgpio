int is_device_string ( const char* string ) {
  ...
  if ( strlen(string)==4 || strlen(string)==5 ) {
    ...
    str3                      = string[3];
    if ( strlen(string) == 4 ) {
      // led0, led1, led2, led3, LED0, LED1, LED2 or LED3
      if ( ( ( str0==76 && str1==69 && str2==68 ) || ( str0==108 && str1==101 && str2==100 ) ) && ( str3==48 || str3==49 || str3==50 || str3==51 ) )
        is                    = 0 + 1 + (str3-ZEROTXT);
      // btn0, btn1, btn2, BTN0, BTN1 or BTN2
      if ( ( ( str0==66 && str1==84 && str2==78 ) || ( str0==98  && str1==116 && str2==110 ) ) && ( str3==48 || str3==49 || str3==50 ) )
        is                    = 0 - 1 - (str3-ZEROTXT);
      // pleb or PLEB
      if ( ( str0==80 && str1==76 && str2==69 && str3==66 ) || ( str0==112  && str1==108 && str2==101 && str3==98 ) )
        is                    = 0 - 11;
    } else {
      str4                    = string[4];
      // progx or PROGx, where x is 1, 2, 3, 4, 5, 6, 7, 8, 9, A, B, C, D, E or F
  ...
  if ( unmatched_sect(is) ) {
    ...
    if ( pleb_sect(is) ) {
      ...
      if(strcmp("prog",name)==0)
        if ( strcmp("1",valu)==0 || strcmp("2",valu)==0 || strcmp("3",valu)==0 || strcmp("4",valu)==0 ) 
